...
$consumer_key = 'pHShtqZcJSqkyaDilKhQ';
/* Consumer Secret from twitter */
$consumer_secret = 'utkUqAHp6MPx3KJ5E6nm82o4XXIMdJbAB8qkzfR3A';
/* Set up placeholder */
$content = NULL;
...
<html>
  ...
  <body>
    ...
    <p>This site is a basic showcase of Twitters new OAuth authentication method. Everything is saved in sessions. If you want to start over <a href="<?=$_SERVER['PHP_SELF']?>?test=clear">clear sessions</a>.</p>
    <p>Consumer Key: <input type="text" size="60" value="<?=$consumer_key?>" onfocus="this.select()" /><br />
  Consumer Secret: <input type="text" size="60" value="<?=$consumer_secret?>" onfocus="this.select()" /><br />
  Access Token: <input type="text" size="60" value="<?=$_SESSION['oauth_access_token']?>" onfocus="this.select()" /><br />
  Access Token Secret: <input type="text" size="60" value="<?=$_SESSION['oauth_access_token_secret']?>" onfocus="this.select()" />
    </p>
    <p>
